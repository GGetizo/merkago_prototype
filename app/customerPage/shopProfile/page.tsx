...
export default function ShopPage() {
  return (
    <div className="w-full min-h-screen bg-gray-50 pb-24">
      ...
      {/* SHOP INFO CARD */}
      <div className="relative -mt-10 mx-4 rounded-xl bg-white shadow p-4 z-40">
        {/* Logo + Name + Buttons */}
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-1">
            <h1 className="text-xl font-bold">Mang Berto’s Choice Cuts</h1>
            <p className="text-xs text-gray-500">Active 10 minutes ago</p>
      ...
      {/* NAV TABS */}
      <div className="flex mt-4 border-b bg-white px-4 text-sm">
        <button className="py-3 border-b-2 border-red-500 text-red-500 font-semibold mr-6">
          Home
        </button>
        <button className="py-3 mr-6">All Products</button>
        <button className="py-3 mr-6">Meat Cuts</button>
        <button className="py-3 mr-6">Fish</button>
        <button className="py-3 mr-6">Vegetables</button>
      </div>

    {/* Home */}
      {/* VOUCHERS SECTION */}
      <div className="bg-white mx-4 mt-4 rounded-lg shadow p-4">
        <h2 className="font-bold text-gray-800 mb-3">Shop Vouchers</h2>

        <div className="space-y-3">
          {/* Voucher Card */}
          <div className="border border-red-300 rounded-lg p-4 flex justify-between items-center bg-red-50">
            <div>
              <p className="text-lg font-bold text-red-600">₱10 off</p>
              <p className="text-xs text-gray-600">Min. Spend ₱199</p>
              <p className="text-xs mt-1 text-gray-500">Valid until: Feb 2030</p>
            </div>
          ...
          <div className="border border-red-300 rounded-lg p-4 flex justify-between items-center bg-red-50">
            <div>
              <p className="text-lg font-bold text-red-600">₱25 off</p>
              <p className="text-xs text-gray-600">Min. Spend ₱150</p>
              <p className="text-xs mt-1 text-gray-500">Expires in 2 days</p>
            </div>
            <button className="px-4 py-2 bg-red-600 text-white text-sm rounded">
              Claim
            </button>
