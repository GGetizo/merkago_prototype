...
export default function SettingsComponent() {
  ...
  return (
    <div className="w-full p-4 space-y-4">
      ...
      {/* Premium Subscription Modals */}
      <PremiumSubscription
        showPaymentModal={showPaymentModal}
        showConfirmationModal={showConfirmationModal}
        showManageSubscriptionModal={showManageSubscriptionModal}
        ...
        onCloseManageSubscription={() => setShowManageSubscriptionModal(false)}
        onSubscribeSuccess={() => setIsSubscribed(true)}
        onCancelSuccess={() => setIsSubscribed(false)}
